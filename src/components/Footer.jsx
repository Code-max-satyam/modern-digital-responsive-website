        ...
        <motion.div
            ...
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                <motion.div
                    ...
                    <img src={theme === 'dark' ? assets.logosdark : assets.logos} className='w-32 sm:w-44' alt="" />
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.4 }}
                viewport={{ once: true }} className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
                <p>Copyright 2025 © NexusAI - All Right Reserved.</p>
